...
def get_conditions(filters):
	...
	if filters.get("charactristics_group"):
		conditions += " and sle.charactristics_group = %s" % frappe.db.escape(filters.get("charactristics_group"))

	if filters.get("charactristics"):
		conditions += " and sle.charactristics = %s" % frappe.db.escape(filters.get("charactristics"))
	return conditions
